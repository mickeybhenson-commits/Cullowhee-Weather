...
(Unchanged in the 2026-07 improvement set — this is the §5 data-blocked handler
that runs the moment the HEC-RAS cut-line shapefiles arrive. The frequency
classification in flood_rating.py is the interim for the seven non-campus reaches;
the surveyed thresholds this emits will later add a second, independent stage
check.)
