...
TOOLS = {
    ...
    "reach_rating",         # CLI: builds data/reach_ratings.json (LiDAR sections at the five tributary pour points);
                            # cwm_model.stage_total / depth_above_bed / watch_rung and live.html read the JSON
